"""
Django settings for infognome_41542 project.
...
ROOT_URLCONF = 'infognome_41542.urls'
...
WSGI_APPLICATION = 'infognome_41542.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "infognome_41542 API",
    "DESCRIPTION": "API documentation for infognome_41542 App",
    "VERSION": "v1",
}
